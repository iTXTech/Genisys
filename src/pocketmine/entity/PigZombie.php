...
class PigZombie extends Monster{
	...
	public function getDrops(){
		...
		if($cause instanceof EntityDamageByEntityEvent and $cause->getDamager() instanceof Player){
			...
			if(mt_rand(1, 200) <= (5 + 2 * $lootingLevel)){
				$drops[] = ItemItem::get(ItemItem::GOLD_INGOT, 0, 1);
			}
			$drops[] = ItemItem::get(ItemItem::GOLD_NUGGET, 0, mt_rand(0, 1 + $lootingLevel));
			$drops[] = ItemItem::get(ItemItem::ROTTEN_FLESH, 0, mt_rand(0, 1 + $lootingLevel));
		}
		return $drops;
	}
}